          ...
          <nav className="app-nav">
            ...
            >
              ...
              >
                ...
                <path
                  d="M13 5.00001H21V7.00001H13V5.00001Z"
                  fill="currentColor"
                />
                <path d="M21 11H3V13H21V11Z" fill="currentColor" />
                <path
                  d="M3 3.00001H11V5.00001H3V3.00001Z"
                  fill="currentColor"
                />
                <path
                  d="M11 7.00001H3V9.00001H11V7.00001Z"
                  fill="currentColor"
                />
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M3.05078 11.0002C3.27805 7.56152 5.71096 4.64312 9.0001 3.76643C12.2892 2.88975 15.7648 4.27499 17.4966 7.21024C19.2284 10.1455 18.8102 13.916 16.4289 16.3668C14.0475 18.8176 10.2653 19.3433 7.22474 17.7646"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            >
              {isDarkMode ? (
                ...
                >
                  ...
                  />
                  <path
                    d="M5.63672 5.63672L7.05093 7.05093"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                  <path
                    d="M16.9492 16.9492L18.3634 18.3634"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                  <path
                    d="M5.63672 18.3634L7.05093 16.9492"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                  <path
                    d="M16.9492 7.05093L18.3634 5.63672"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                ...
                >
                  <path
                    d="M20.9999 12.8C20.9559 14.5936 20.3699 16.3323 19.3193 17.7924C18.2688 19.2525 16.7948 20.3567 15.096 20.9692C13.3972 21.5817 11.5532 21.6795 9.79911 21.2498C8.04505 20.82 6.46402 19.882 5.27195 18.5625C4.07988 17.243 3.32872 15.6031 3.10562 13.8667C2.88253 12.1302 3.19552 10.3771 3.99919 8.83311C4.80287 7.28916 6.06367 6.02403 7.62465 5.18864C9.18563 4.35325 10.9749 3.98265 12.7599 4.12C11.985 5.37572 11.7681 6.86594 12.1568 8.27591C12.5455 9.68589 13.5085 10.8996 14.7999 11.64C16.0913 12.3804 17.6129 12.5983 19.0633 12.2479C20.5138 11.8975 21.7751 11.0055 22.5999 9.76C22.8687 10.7473 23.0055 11.7714 22.9999 12.8H20.9999Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <main className="app-main">
          <header className="app-header">
            ...
            <div className="header-actions">
              ...
              |
              <a
                href="https://github.com/kamalkoranga/postman-clone"
                target="_blank"
