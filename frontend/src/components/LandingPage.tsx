  ...
  return (
    <div className="landing-page">
      ...
      <header className="landing-hero">
        <div className="landing-container">
          <div className="hero-content">
            ...
            <h2>A Modern API Testing Platform</h2>
            <p className="hero-subtitle">
              Build, test, and document your APIs faster and smarter with RESTLab - the next generation API client.
            </p>
      ...
      <section className="how-it-works-section">
        <div className="landing-container">
          <h2 className="section-title">How RESTLab Works</h2>
      ...
      <section className="cta-section">
        <div className="landing-container">
          <h2>Ready to start building better APIs?</h2>
          <p>Join thousands of developers who are already using RESTLab to test and document their APIs.</p>
          <button 
